...
{
    /// <summary>
    /// A <see cref="MeshBuilderAsync"/>-friendly
    /// wrapper for relevant MapTile references.
    /// </summary>
    [PublicAPI]
    public class MeshTile : ITilePair
    {
        #region ITilePair
        ...
        /// <summary>
        /// The <see cref="MeshFilter"/> used to render the <see cref="IMapTile"/>'s
        /// features for a given <see cref="MeshBuilderAsync"/> on the corresponding
        /// <see cref="IMapTileObject"/>.
        /// </summary>
        public readonly MeshFilter Filter;

        /// <summary>
        /// The <see cref="MeshTile"/>'s
        ...
        /// <summary>
        /// Associates a <see cref="TilePair"/> with the <see cref="MeshFilter"/>
        /// used for a given <see cref="MeshBuilderAsync"/>.
        /// </summary>
        ...
        /// <param name="filter">The <see cref="MeshFilter"/> used to render the
        /// <see cref="IMapTile"/>'s features for a given <see cref="MeshBuilderAsync"/>
        /// on the corresponding <see cref="IMapTileObject"/>.</param>
        public MeshTile(TilePair tilePair, MeshFilter filter)
        {
            _tilePair = tilePair;
            Filter = filter;
        }
